          ...
          <div className="border border-primary/40 bg-primary/5 p-6 rounded-lg mb-8">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <h2 className="font-bold uppercase font-mono text-primary text-sm">{t("dash_active_job")}</h2>
              </div>
            ...
            <p className="text-xs font-mono text-muted-foreground mt-2">{t("dash_tech_label")} {activeBooking.technicianName ?? "Assigned"}</p>
          </div>
        )}
